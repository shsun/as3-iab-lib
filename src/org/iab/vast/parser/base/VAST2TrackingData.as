package org.iab.vast.parser.base {
	public dynamic class VAST2TrackingData {
		...
		public function set impressionArray(val : Array) : void {
			_impressionArray = val;
		}
		...
		public function set surveyArray(val : Array) : void {
			_surveyArray = val;
		}
		...
		public function set errorArray(val : Array) : void {
			_errorArray = val;
		}

		// Linear
		public function get clickTrackingArray() : Array {
			return _clickTrackingArray;
		}

		public function set clickTrackingArray(val : Array) : void {
			_clickTrackingArray = val;
		}
		...
		public function set trkStartEvent(val : Array) : void {
			_trkStartEvent = val;
		}
		...
		public function set trkCreativeViewEvent(val : Array) : void {
			_trkCreativeViewEvent = val;
		}
		...
		public function set trkMidPointEvent(val : Array) : void {
			_trkMidPointEvent = val;
		}
		...
		public function set trkFirstQuartileEvent(val : Array) : void {
			_trkFirstQuartileEvent = val;
		}
		...
		public function set trkThirdQuartileEvent(val : Array) : void {
			_trkThirdQuartileEvent = val;
		}
		...
		public function set trkCompleteEvent(val : Array) : void {
			_trkCompleteEvent = val;
		}
		...
		public function set trkMuteEvent(val : Array) : void {
			_trkMuteEvent = val;
		}
		...
		public function set trkUnmuteEvent(val : Array) : void {
			_trkUnmuteEvent = val;
		}
		...
		public function set trkPauseEvent(val : Array) : void {
			_trkPauseEvent = val;
		}
		...
		public function set trkFullScreenEvent(val : Array) : void {
			_trkFullScreenEvent = val;
		}
		...
		public function set trkCloseEvent(val : Array) : void {
			_trkCloseEvent = val;
		}
		...
		public function set trkRewindEvent(val : Array) : void {
			_trkRewindEvent = val;
		}
		...
		public function set trkResumeEvent(val : Array) : void {
			_trkResumeEvent = val;
		}
		...
		public function set trkExpandEvent(val : Array) : void {
			_trkExpandEvent = val;
		}
		...
		public function set trkCollapseEvent(val : Array) : void {
			_trkCollapseEvent = val;
		}
		...
		public function set trkAcceptInvitationEvent(val : Array) : void {
			_trkAcceptInvitationEvent = val;
		}
		...
		public function set trkStartEventNonLinear(val : Array) : void {
			_trkStartEventNonLinear = val;
		}
		...
		public function set trkCreativeViewEventNonLinear(val : Array) : void {
			_trkCreativeViewEventNonLinear = val;
		}
		...
		public function set trkMidPointEventNonLinear(val : Array) : void {
			_trkMidPointEventNonLinear = val;
		}
		...
		public function set trkFirstQuartileEventNonLinear(val : Array) : void {
			_trkFirstQuartileEventNonLinear = val;
		}
		...
		public function set trkThirdQuartileEventNonLinear(val : Array) : void {
			_trkThirdQuartileEventNonLinear = val;
		}
		...
		public function set trkCompleteEventNonLinear(val : Array) : void {
			_trkCompleteEventNonLinear = val;
		}
		...
		public function set trkMuteEventNonLinear(val : Array) : void {
			_trkMuteEventNonLinear = val;
		}
		...
		public function set trkUnmuteEventNonLinear(val : Array) : void {
			_trkUnmuteEventNonLinear = val;
		}
		...
		public function set trkPauseEventNonLinear(val : Array) : void {
			_trkPauseEventNonLinear = val;
		}
		...
		public function set trkFullScreenEventNonLinear(val : Array) : void {
			_trkFullScreenEventNonLinear = val;
		}
		...
		public function set trkCloseEventNonLinear(val : Array) : void {
			_trkCloseEventNonLinear = val;
		}
		...
		public function set trkRewindEventNonLinear(val : Array) : void {
			_trkRewindEventNonLinear = val;
		}
		...
		public function set trkResumeEventNonLinear(val : Array) : void {
			_trkResumeEventNonLinear = val;
		}
		...
		public function set trkExpandEventNonLinear(val : Array) : void {
			_trkExpandEventNonLinear = val;
		}
		...
		public function set trkCollapseEventNonLinear(val : Array) : void {
			_trkCollapseEventNonLinear = val;
		}
		...
		public function set trkAcceptInvitationEventNonLinear(val : Array) : void {
			_trkAcceptInvitationEventNonLinear = val;
		}

		public function get clickTrackingArrayNonLinear() : Array {
			return _clickTrackingArrayNonLinear;
		}

		public function set clickTrackingArrayNonLinear(val : Array) : void {
			_clickTrackingArrayNonLinear = val;
		}

		// Prevent errors
		public function get trkStopEvent() : Array {
			return trkCloseEvent;
		}
